<%@ Page Title="" Language="C#" MasterPageFile="~/ClientVisitMapMaster.Master" AutoEventWireup="true" CodeBehind="WoodlandsClientsSchedule.aspx.cs" Inherits="ClientVisitMap.WoodlandsClientsSchedule" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var clientsSchedule = JSON.parse('<%= getClients() %>');
        ...
        function load() {                    
            ...
            {        
                var schdlData = clientsSchedule[schdlIndx];
                var schdleName = schdlData.schdlCmpName;
                var member = schdlData.schdlCmpMembId;
                var schdlAddress = clientsSchedule[schdlIndx].schdlCmpAddr1 + ", " + clientsSchedule[schdlIndx].schdlCity + ", " + clientsSchedule[schdlIndx].schdlState + " " + clientsSchedule[schdlIndx].schdlZip;
                var startStr = clientsSchedule[schdlIndx].schdlStart;
                var endStr = clientsSchedule[schdlIndx].schdlEnd;
        ...
        function centerClient(){
            ...
            {                                
                ...
                {                 
                    ...
                    {                        
                        if (clientList.options[i].value == clientsSchedule[j].schdlCmpName + " - " + clientsSchedule[j].schdlServiceId)
                        {
                            var point = new google.maps.LatLng(clientsSchedule[j].llLat, clientsSchedule[j].llLng);
                            map.setCenter(point);
                            if (map.getZoom() < 16){map.setZoom(18);}
                            infoWindow.setContent("<b>" + clientsSchedule[j].schdlCmpName + "</b> <br />Click pin for details.");
        ...
        function CenterControl(array, controlDiv, map, center) {
            ...
            var woodlands = new google.maps.LatLng(30.182951, -95.522478)

            //WOODLANDS BUTTON-----------------------------------------
            // Set CSS for the control border
            var wdlndsCenterUI = document.createElement('div');
            wdlndsCenterUI.id = 'UI';
            wdlndsCenterUI.title = 'Click to recenter to Woodlands';
    ...
    <h2 style="text-align: center;margin-bottom: 0;">WOODLANDS CLIENTS</h2>
                ...
                <td class="btmdiv" style="padding-left: 15px;">
                   ...
                   <div id="listBoxDiv" style="overflow: auto; width: 275px; height: 450px;"">
                    ...
                    <table class="regionbtns" style="padding-top: 16px;">
                         <tr>
                            <td>
                                <input type="button" id="houstonBtn" onclick="document.location.href = 'HoustonClientsSchedule.aspx'" value="Houston"/>
                        ...
                        <tr>
                            <td>        
                                <input type="button" disabled="disabled" onclick="document.location.href = 'WoodlandsClientsSchedule.aspx'" value="Woodlands" />
